...
python -u parameterized_inference.py regression
python -u parameterized_inference.py regression shallow
python -u parameterized_inference.py regression deep