...
if do_train:
    ...
    np.save('../data/unweighted_events/theta0_train' + filename_addition + '.npy', th0)
    np.save('../data/unweighted_events/theta1_train' + filename_addition + '.npy', th1)
    np.save('../data/unweighted_events/X_train' + filename_addition + '.npy', X)
    np.save('../data/unweighted_events/y_train' + filename_addition + '.npy', y)
    np.save('../data/unweighted_events/scores_train' + filename_addition + '.npy', scores)
    np.save('../data/unweighted_events/r_train' + filename_addition + '.npy', r)
    np.save('../data/unweighted_events/p_score_train' + filename_addition + '.npy', p_score)
...
if do_basis:
    ...
    np.save('../data/unweighted_events/theta0_train_basis' + filename_addition + '.npy', th0)
    np.save('../data/unweighted_events/theta1_train_basis' + filename_addition + '.npy', th1)
    np.save('../data/unweighted_events/X_train_basis' + filename_addition + '.npy', X)
    np.save('../data/unweighted_events/y_train_basis' + filename_addition + '.npy', y)
    np.save('../data/unweighted_events/scores_train_basis' + filename_addition + '.npy', scores)
    np.save('../data/unweighted_events/r_train_basis' + filename_addition + '.npy', r)
    np.save('../data/unweighted_events/p_score_train_basis' + filename_addition + '.npy', p_score)
...
if do_random:
    ...
    np.save('../data/unweighted_events/theta0_train_random' + filename_addition + '.npy', th0)
    np.save('../data/unweighted_events/theta1_train_random' + filename_addition + '.npy', th1)
    np.save('../data/unweighted_events/X_train_random' + filename_addition + '.npy', X)
    np.save('../data/unweighted_events/y_train_random' + filename_addition + '.npy', y)
    np.save('../data/unweighted_events/scores_train_random' + filename_addition + '.npy', scores)
    np.save('../data/unweighted_events/r_train_random' + filename_addition + '.npy', r)
...
if do_calibration:
    ...
    np.save('../data/unweighted_events/X_calibration' + filename_addition + '.npy', X)
    np.save('../data/unweighted_events/weights_calibration' + filename_addition + '.npy', weights)
...
if do_test:
    ...
    np.save('../data/unweighted_events/X_test' + filename_addition + '.npy', X)
    np.save('../data/unweighted_events/scores_test' + filename_addition + '.npy', scores)
    np.save('../data/unweighted_events/r_test' + filename_addition + '.npy', r)
    np.save('../data/unweighted_events/p_score_test' + filename_addition + '.npy', p_score)
...
if do_roam:
    ...
    np.save('../data/unweighted_events/X_roam' + filename_addition + '.npy', X)
    np.save('../data/unweighted_events/r_roam' + filename_addition + '.npy', r)
