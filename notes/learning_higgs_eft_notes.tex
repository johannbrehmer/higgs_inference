...
\begin{table}
  ...
  \begin{tabular}{ll rr rr}
   ...
   PbP carl (cal.) & PbP (1) &  &  &  & \\
    ...
    & PbP (3) &  &  &  & \\
   \midrule
   Param carl (raw) & Baseline (1) & $0.0395$ & $0.0735$ & $2.777$ & $0.720$\\
    & Baseline (2) & $0.0830$ & $0.1158$ & $29.685$ & $5.491$\\
    & Baseline (3) &  &  &  & \\
    & Random $\boldtheta$ (1) & $0.0471$ & $0.0655$ & $1.411$ & $1.530$\\
    & Random $\boldtheta$ (2) & $\mathbf{0.0374}$ & $\mathbf{0.0536}$ & $\mathbf{0.849}$ & $\mathbf{0.703}$\\
    & Random $\boldtheta$ (3) &  &  &  & \\
    & Physics-aware (1) &  &  &  & \\
    & Physics-aware (2) &  &  &  & \\
    & Physics-aware (3) &  &  &  & \\
   \midrule
   Param carl (cal.) & Baseline (1) & $\mathbf{0.0331}$ & $0.0496$ & $0.236$ & $0.414$\\
    & Baseline (2) &  &  &  & \\
    & Baseline (3) &  &  &  & \\
    & Random $\boldtheta$ (1) & $0.0338$ & $\mathbf{0.0477}$ & $\mathbf{0.093}$ & $\mathbf{0.300}$\\
    & Random $\boldtheta$ (2) &  &  &  & \\
    & Random $\boldtheta$ (3) &  &  &  & \\
    & Physics-aware (1) &  &  &  & \\
    & Physics-aware (2) &  &  &  & \\
...
\begin{table}
  ...
  \begin{tabular}{ll rr rr}
   ...
   Param score (cal.) & Baseline (1) &  &  &  & \\
    ...
    & Physics-aware (3) &  &  &  & \\
   \midrule
   Param carl + score (raw) & Baseline (1) & $0.0371$ & $0.0494$ & $2.114$ & $0.186$\\
    & Baseline (2) & $\mathbf{0.0137}$ & $\mathbf{0.0163}$ & $\mathbf{0.662}$ & $\mathbf{0.157}$\\
    & Baseline (3) &  &  &  & \\
    & Random $\boldtheta$ (1) & $0.0498$ & $0.0817$ & $1.529$ & $3.621$\\
    & Random $\boldtheta$ (2) & $0.0382$ & $0.0629$ & $2.083$ & $3.498$\\
    & Random $\boldtheta$ (3) &  &  &  & \\
    & Physics-aware (1) &  &  &  & \\
    & Physics-aware (2) &  &  &  & \\
    & Physics-aware (3) &  &  &  & \\
   \midrule
   Param carl + score (cal.) & Baseline (1) & $\mathbf{0.0280}$ & $\mathbf{0.0410}$ & $\mathbf{0.069}$ & $\mathbf{0.072}$\\
    & Baseline (2) &  &  &  & \\
    & Baseline (3) &  &  &  & \\
    & Random $\boldtheta$ (1) & $0.0366$ & $0.0577$ & $0.485$ & $0.974$\\
    & Random $\boldtheta$ (2) &  &  &  & \\
    & Random $\boldtheta$ (3) &  &  &  & \\
    & Physics-aware (1) &  &  &  & \\
    & Physics-aware (2) &  &  &  & \\
...
\begin{table}
  ...
  \begin{tabular}{ll rr rr}
    ...
    & PbP (3) &  &  &  & \\
   \midrule
   Param regression (raw) & Baseline (1) & $0.0147$ & $0.0215$ & $0.118$ & $0.119$\\
    & Baseline (2) & $\mathbf{0.0038}$ & $\mathbf{0.0052}$ & $0.156$ & $0.144$\\
    & Baseline (3) & $0.0067$ & $0.0073$ & $0.301$ & $0.289$\\
    & Random $\boldtheta$ (1) & $0.0147$ & $0.0215$ & $0.403$ & $0.216$\\
    & Random $\boldtheta$ (2) & $0.0046$ & $0.0069$ & $0.205$ & $\mathbf{0.018}$\\
    & Random $\boldtheta$ (3) & $0.0066$ & $0.0077$ & $\mathbf{0.035}$ & $0.030$\\
    & Physics-aware (1) &  &  &  & \\
    & Physics-aware (2) &  &  &  & \\
    & Physics-aware (3) &  &  &  & \\
   \midrule
...
\begin{figure}
  \includegraphics[width=\textwidth]{figures/parameterized_r_histograms_vanilla.pdf}%
...
\begin{figure}
  \includegraphics[width=\textwidth]{figures/parameterized_r_scatter_vanilla.pdf}%
...
\begin{figure}
  \includegraphics[width=\textwidth]{figures/parameterized_score_scatter_vanilla.pdf}%
...
\begin{figure}
  \includegraphics[width=\textwidth]{figures/parameterized_theta_dependence_comparison_vanilla.pdf}%
...
\begin{figure}
  \includegraphics[width=\textwidth]{figures/parameterized_expected_likelihood_scatter_vanilla.pdf}%
...
\begin{figure}
  \includegraphics[width=\textwidth]{figures/parameterized_likelihood_contours_vanilla.pdf}%
...
\begin{figure}
  \includegraphics[width=\textwidth]{figures/morphing_original.pdf}%
...
\begin{figure}
  \includegraphics[width=\textwidth]{figures/morphing_optimized2.pdf}%
