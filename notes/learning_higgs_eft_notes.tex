...
\begin{table}
  ...
  \begin{tabular}{ll rr rr rr}
    ...
    \midrule
   AFC & PbP (2) & \emph{0.094} & \emph{0.119} & \emph{15.4} & \emph{13.8}\\
   \midrule
   carl (PbP, raw) & PbP (2) & \emph{0.061} & \emph{0.167} & \emph{286.2} & \emph{236.4}\\
   \midrule
   carl (PbP, cal.) & PbP (2) & \emph{0.027} & \emph{0.031} & \emph{1.7} & \emph{1.7}\\
   \midrule
   carl (param., raw) & Baseline (2) & \emph{0.025} & \emph{0.037} & \emph{19.5} & \emph{23.4}\\
    & Random $\boldtheta$ (2) & 0.040 & 0.053 & 43.3 & 125.8\\
    & Physics-aware, baseline (2) & 0.265 & (0.449) & (121.4) & (80.5)\\
    & Physics-aware, morphing basis (2) &  &  &  & \\
   \midrule
   carl (param., cal.) & Baseline (2) & \emph{0.024} & \emph{0.035} & \emph{1.5} & \emph{1.9}\\
    & Random $\boldtheta$ (2) & 0.028 & 0.039 & 45.4 & 114.3\\
...
\begin{table}
  ...
  \begin{tabular}{ll rr rr rr}
    ...
    && $\boldtheta_0 = \boldtheta_{T}$ & $\boldtheta_0 = \boldtheta_{NT}$
      & $\boldtheta_{\text{den}} = \boldtheta_1$ & $\boldtheta_{\text{den}} = \hat{\boldtheta}_{\text{MLE}}$ \\
   \midrule
   carl + score (param., raw) & Baseline (2) & \emph{0.022} & \emph{0.023} & \emph{44.8} & \emph{0.9}\\
    & Random $\boldtheta$ (2) & 0.047 & 0.065 & 48.3 & 149.1\\
    & Physics-aware, baseline (2) & 0.234 & 0.291 & (61.9) & (78.0)\\
    & Physics-aware, morphing basis (2) &  &  &  & \\
   \midrule
   carl + score (param., cal.) & Baseline (2) & \emph{0.013} & \emph{0.015} & \emph{2.1} & \emph{1.6}\\
    & Random $\boldtheta$ (2) & 0.022 & 0.030 & 51.2 & 124.2\\
    & Physics-aware, baseline (2) &  &  &  & \\
    & Physics-aware, morphing basis (2) &  &  &  & \\
   \midrule
   SM score regression & Fixed density est. on $t$  (2) &  &  &  & \\
    & Dynamic density est. on $t$  (2) &  &  &  & \\
    & Density est. on $t \cdot \theta$  (2) & \emph{0.507} & \emph{0.459} & \emph{16.2} & \emph{29.5}\\
    \bottomrule
  \end{tabular}
...
\begin{table}
  ...
  \begin{tabular}{ll rr rr rr}
    ...
    && $\boldtheta_0 = \boldtheta_{T}$ & $\boldtheta_0 = \boldtheta_{NT}$
      & $\boldtheta_{\text{den}} = \boldtheta_1$ & $\boldtheta_{\text{den}} = \hat{\boldtheta}_{\text{MLE}}$ \\
    \midrule
   Regression (PbP, raw) & PbP (2) & \emph{0.002} & \emph{0.003} & \emph{3.1} & \emph{3.2}\\
   \midrule
   Regression (param., raw) & Baseline (2) & \emph{0.004} & \emph{0.005} & \emph{1.1} & \emph{1.0}\\
    & Random $\boldtheta$ (2) & 0.005 & 0.008 & 2.5 & 3.0\\
    & Physics-aware, baseline (2) & 0.027 & 0.378 & 183.1 & 174.8\\
    & Physics-aware, morphing basis (2) & 0.015 & 85.603 & 9484.8 & 17392.3\\
   \midrule
   Regr.\ + score (param., raw) & Baseline (2) & \emph{0.005} & \emph{0.006} & \emph{1.7} & 1.3\\
    & Random $\boldtheta$ (2) & 0.005 & 0.006 & 2.4 & \emph{1.0}\\
    & Physics-aware, baseline (2) & 0.054 & 0.335 & 178.7 & 180.8\\
    & Physics-aware, morphing basis (2) &  &  &  & \\
    \bottomrule
  \end{tabular}
...
\begin{figure}
  ...
  \caption{Error in estimating the expected log likelihood ratio over $\boldtheta_0$,
    ...
    parameterized models.}
  \label{fig:baseline_likelihood_ratio_errors}
\end{figure}
