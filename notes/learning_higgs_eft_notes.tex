...
\begin{table}
  ...
  \begin{tabular}{llr}
   ...
   carl + score (param., raw) & Baseline & $0.00070$\\
    ...
    & Random $\boldtheta$, $\alpha = 0.5$ & $0.00075$\\
    & Random $\boldtheta$, $\alpha = 2$ & $0.00075$\\
    & Random $\boldtheta$, $\alpha = 5$ & $0.00059$\\
    & Random $\boldtheta$, $\alpha = 10$ & $\mathbf{0.00052}$\\
   \midrule
   carl + score (param., cal.) & Baseline & $0.00058$\\
    ...
    & Random $\boldtheta$, $\alpha = 0.1$ & $0.00129$\\
    & Random $\boldtheta$, $\alpha = 0.2$ & $0.00096$\\
    & Random $\boldtheta$, $\alpha = 0.5$ & $0.00066$\\
    & Random $\boldtheta$, $\alpha = 2$ & $0.00052$\\
    & Random $\boldtheta$, $\alpha = 5$ & $0.00055$\\
    & Random $\boldtheta$, $\alpha = 10$ & $0.00052$\\
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \bottomrule
  \end{tabular}
...
\begin{table}
  ...
  \begin{tabular}{llr}
   ...
   Ratio + score regr.\ (param., cal.) & Baseline & $0.00070$\\
    ...
    & Baseline, $\alpha = 100$ & $0.00062$\\
    & Random $\boldtheta$ & $0.00072$\\
    & Random $\boldtheta$, shallow & $0.00112$\\
    & Random $\boldtheta$, deep & $0.00066$\\
    & Random $\boldtheta$, $\alpha = 5$ & $0.00109$\\
    & Random $\boldtheta$, $\alpha = 10$ & $0.00086$\\
    & Random $\boldtheta$, $\alpha = 50$ & $0.00061$\\
    & Random $\boldtheta$, $\alpha = 100$ & $\mathbf{0.00061}$\\
   \midrule
...
\begin{figure}
  \includegraphics[width=\textwidth]{figures/morphing/morphing_big.pdf}%
