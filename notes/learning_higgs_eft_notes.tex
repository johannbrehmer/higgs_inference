...
\begin{table}
  ...
  \begin{tabular}{ll rr rr rr}
    ...
    \midrule
   AFC & PbP (2) & \emph{0.094} & \emph{0.119} &  &  &  & \\
   \midrule
   carl (PbP, raw) & PbP (2) & \emph{0.061} & \emph{0.167} & \emph{319.75} & \emph{65.57} & \emph{18.91} & \emph{18.91}\\
   \midrule
   carl (PbP, cal.) & PbP (2) & \emph{0.027} & \emph{0.031} & \emph{44.75} & \emph{112.43} & \emph{32.66} & \emph{32.66}\\
   \midrule
   carl (param., raw) & Baseline (2) & \emph{0.025} & \emph{0.037} & \emph{19.47} & \emph{23.42} & \emph{13.92} & \emph{13.92}\\
    & Random $\boldtheta$ (2) & 0.040 & 0.053 & 43.28 & 125.83 & 37.18 & 37.18\\
    & Physics-aware, baseline (2) & 0.265 & (0.449) & (121.38) & (80.45) &  & \\
    & Physics-aware, morphing basis (2) &  &  &  &  &  & \\
   \midrule
   carl (param., cal.) & Baseline (2) & 0.028 & \emph{0.035} & 47.46 & 116.90 & 34.12 & 34.12\\
    & Random $\boldtheta$ (2) & \emph{0.028} & 0.039 & \emph{45.41} & \emph{114.29} & \emph{33.13} & \emph{33.13}\\
...
\begin{table}
  ...
  \begin{tabular}{ll rr rr rr}
    ...
    && $\boldtheta_0 = \boldtheta_{T}$ & $\boldtheta_0 = \boldtheta_{NT}$
      & $\boldtheta_{\text{den}} = \boldtheta_1$ & $\boldtheta_{\text{den}} = \hat{\boldtheta}_{\text{MLE}}$ \\
   \midrule
  carl + score (param., raw) & Baseline (2) & \emph{0.022} & \emph{0.023} & \emph{44.81} & \emph{0.90} & \emph{0.77} & \emph{0.77}\\
    & Random $\boldtheta$ (2) & 0.047 & 0.065 & 48.25 & 149.13 & 45.16 & 45.16\\
    & Physics-aware, baseline (2) & 0.234 & 0.291 & (61.93) & (78.01) &  & \\
    & Physics-aware, morphing basis (2) &  &  &  &  &  & \\
   \midrule
   carl + score (param., cal.) & Baseline (2) & \emph{0.011} & \emph{0.015} & \emph{47.72} & \emph{116.17} & \emph{33.25} & \emph{33.25}\\
    & Random $\boldtheta$ (2) & 0.022 & 0.030 & 51.22 & 124.21 & 36.66 & 36.66\\
    & Physics-aware, baseline (2) &  &  &  &  &  & \\
    & Physics-aware, morphing basis (2) &  &  &  &  &  & \\
   \midrule
   Score regression & Fixed density est. on $t$  (2) &  &  &  &  &  & \\
    & Dynamic density est. on $t$  (2) &  &  &  &  &  & \\
    & Density est. on $t \cdot \theta$  (2) & \emph{0.507} & \emph{0.459} & \emph{16.17} & \emph{29.46} & \emph{10.27} & \emph{10.27}\\
    \bottomrule
  \end{tabular}
...
\begin{table}
  ...
  \begin{tabular}{ll rr rr rr}
   ...
   PbP regression (raw) & PbP (1) &  &  &  &  &  & \\
    ...
    & PbP (3) &  &  &  &  &  & \\
   \midrule
   Regression (PbP, raw) & PbP (2) & \emph{0.002} & \emph{0.003} & (\emph{40.57}) &  &  & \\
   \midrule
   Regression (param., raw) & Baseline (2) & \emph{0.004} & \emph{0.005} & \emph{1.11} & \emph{0.95} & \emph{0.65} & \emph{0.65}\\
    & Random $\boldtheta$ (2) & 0.005 & 0.008 & 2.50 & 3.01 & 2.39 & 2.39\\
    & Physics-aware, baseline (2) & 0.027 & 0.378 & 183.07 & 174.79 & 172.60 & 172.60\\
    & Physics-aware, morphing basis (2) & 0.015 & 85.603 & 9484.81 & 17392.32 & 8092.70 & 8092.70\\
   \midrule
   Regr.\ + score (param., raw) & Baseline (2) & \emph{0.005} & \emph{0.006} & \emph{1.69} & 1.30 & 1.21 & 1.21\\
    & Random $\boldtheta$ (2) & 0.005 & 0.006 & 2.42 & \emph{1.02} & \emph{1.01} & \emph{1.01}\\
    & Physics-aware, baseline (2) & 0.054 & 0.335 & 178.66 & 180.78 & 178.58 & 178.58\\
    & Physics-aware, morphing basis (2) &  &  &  &  &  & \\
    \bottomrule
  \end{tabular}
