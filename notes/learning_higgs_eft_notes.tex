...
\begin{table}
  ...
  \begin{tabular}{ll rr rr rr}
   ...
   \midrule
   carl (PbP, raw) & PbP (2) & \emph{0.091} & \emph{0.147} & \\
   \midrule
   carl (PbP, cal.) & PbP (2) & \emph{0.047} & \emph{0.072} &\\
   \midrule
...
\begin{table}
  ...
  \begin{tabular}{ll rr rr rr}
    ...
    && $\boldtheta_0 = \boldtheta_{T}$ & $\boldtheta_0 = \boldtheta_{NT}$
      & $\boldtheta_{\text{den}} = \boldtheta_1$ & $\boldtheta_{\text{den}} = \hat{\boldtheta}_{\text{MLE}}$ \\
    \midrule
   Ratio regression (PbP, raw) & PbP (2) & \emph{0.004} & \emph{0.009} & \\
   \midrule
...
%     & Physics-aware, morphing basis (2) & 1008789.83 & 1053.95\\
%    \midrule
