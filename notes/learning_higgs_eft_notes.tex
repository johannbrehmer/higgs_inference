...
\begin{table}
  ...
  \begin{tabular}{ll rr}
    ...
    \midrule
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   AFC & 2d, $\epsilon = 0.2$ (2) & \emph{0.154} & 5.1\\
    & \emph{2d, $\epsilon = 0.1$ (2)} & 0.160 & 4.2\\
    & 2d, $\epsilon = 0.05$ (2) & 0.182 & 3.8\\
    & 5d, $\epsilon = 0.4$ (2) & 0.172 & 5.3\\
    & 5d, $\epsilon = 0.2$ (2) & 0.244 & 3.6\\
    & 5d, $\epsilon = 0.1$ (2) & 0.970 & \emph{2.7}\\
   \midrule
   carl (param., raw) & Baseline (1) & 0.103 & 2.3\\
    & Baseline (2) & 0.072 & 0.8\\
    & Baseline (3) & 0.080 & 1.1\\
    & Baseline, large batches (2) & 0.062 & \emph{0.5}\\
    & Baseline, small batches (2) & 0.076 & 1.3\\
    & Baseline, const.\  LR (2) & 0.161 & 5.4\\
    & Baseline, const.\  LR, large batches (2) & 0.113 & 6.4\\
    & Baseline, const.\  LR, small batches (2) & 0.113 & 6.4\\
    & Baseline, small LR (2) & 0.057 & 1.2\\
    & Baseline, small LR, large batches (2) & 0.068 & 1.8\\
    & Baseline, small LR, small batches (2) & \emph{0.051} & 1.2\\
    & Baseline, small const.\  LR (2) & 0.078 & 3.4\\
    & Baseline, small const.\  LR, large batches (2) & 0.061 & 1.3\\
    & Baseline, small const.\  LR, small batches (2) & 0.072 & 3.1\\
    & Baseline, large LR (2) & 0.267 & 6.3\\
    & Baseline, large LR, large batches (2) & 0.125 & 1.9\\
...
\begin{table}
  ...
  \begin{tabular}{ll rr}
    ...
    \midrule
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   Ratio regr.\ (param., raw) & Baseline (1) & 0.219 & 4.3\\
    & \emph{Baseline (2)} & 0.063 & \emph{0.6}\\
    & Baseline, large batches (2) & 0.100 & 1.0\\
    & Baseline, small batches (2) & \emph{0.053} & 0.6\\
    ...
    & Baseline, large const.\  LR (2) & 0.121 & 2.3\\
    & Baseline, large const.\  LR, large batches (2) & 0.167 & 3.7\\
    & Random $\boldtheta$ (1) & 0.266 & 4.6\\
    & Random $\boldtheta$ (2) & 0.076 & 1.4\\
   \midrule
   Ratio regr.\ (param., cal.) & Baseline (1) & 0.167 & 2.3\\
    & \emph{Baseline (2)} & 0.061 & \emph{0.3}\\
    & Baseline, large batches (2) & 0.088 & 0.7\\
    & Baseline, small batches (2) & \emph{0.050} & 0.4\\
