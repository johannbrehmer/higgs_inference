...
#SBATCH --job-name=carl-learning
#SBATCH --output=slurm_carl_learning_experiments.out
#SBATCH --nodes=1
...
python -u experiments.py carl -o largebatch
python -u experiments.py carl -o largebatch fastlearning
python -u experiments.py carl -o largebatch slowlearning

python -u experiments.py carl -o fastlearning
python -u experiments.py carl -o slowlearning
