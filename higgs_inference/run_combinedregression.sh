...
#SBATCH --output=slurm_combined_regression.out
#SBATCH --nodes=1
...
# python -u experiments.py combinedregression --training random -o shallow
python -u experiments.py combinedregression --training random
