...
#    calculate_confidence_limits('combinedregression_calibrated_deep_new', 'parameterized', neyman_set)
    ...
    calculate_confidence_limits('histo_2d_smeared_new', 'histo', neyman_set)
    calculate_confidence_limits('scoreregression_score_deep_smeared_new', 'score_regression', neyman_set)
    calculate_confidence_limits('carl_calibrated_shallow_smeared_new', 'parameterized', neyman_set)
    calculate_confidence_limits('combined_calibrated_deep_smeared_new', 'parameterized', neyman_set)
    calculate_confidence_limits('regression_calibrated_smeared_new', 'parameterized', neyman_set)
    calculate_confidence_limits('combinedregression_calibrated_deep_smeared_new', 'parameterized', neyman_set)
